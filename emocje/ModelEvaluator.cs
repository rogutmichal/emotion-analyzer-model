...
namespace emocje
{
    public class ModelEvaluator
    {
        ...
        {
            //Ładowanie danych testowych i przygotowanie ich do ewaluacji
            ...
            // Tworzenie predykcji dla każdego przykładu testowego
            ...
            Console.WriteLine($"\nAccuracy for every emotion ({datasetName}):");

            // Sortowanie etykiet emocji alfabetycznie i wyświetlanie dokładności dla każdej z nich
            ...
            for (int i = 0; i < confusionMatrix.NumberOfClasses; i++)
            {
                ...
                // Obliczanie precyzji, recall i F1-score dla każdej klasy
